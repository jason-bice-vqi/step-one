    ...
    where TContext : DbContext
{
    ...
    IQueryable<T> All<T>(params Expression<Func<T, object>>[]? includes)
        where T : class;
    ...
    /// <returns>IQueryable of all entities</returns>
    IQueryable<T> AllWithChildren<T>(params string[]? includes)
        where T : class;
    ...
    Task<T?> FindAsync<T>(object key, CancellationToken cancellationToken)
        where T : class;
    ...
    /// <param name="cancellationToken">A cancellation token.</param>
    /// <returns>The entity as it exists in the database (will include Id)</returns>
    Task<T> CreateAsync<T>(T entity, CancellationToken cancellationToken)
        where T : class;
    ...
    Task CreateRangeAsync<T>(IList<T> entities, CancellationToken cancellationToken)
        where T : class;
    ...
    Task<int> DeleteAsync<T>(T? entity, CancellationToken cancellationToken)
        where T : class;
    ...
    /// <param name="cancellationToken">A cancellation token.</param>
    Task DeleteRangeAsync<T>(IList<T> entities, CancellationToken cancellationToken)
        where T : class;
    ...
    /// </returns>
    Task<int> UpdateAsync<T>(T entity, CancellationToken cancellationToken)
        where T : class;
    ...
    Task<int> UpdateRangeAsync<T>(IList<T> entities, CancellationToken cancellationToken)
        where T : class;
    ...
    Task<List<T>> RawSqlQueryAsync<T>(string query, CancellationToken cancellationToken)
        where T : class;
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    Task<bool> AnyAsync<T>(CancellationToken cancellationToken)
        where T : class;
    ...
    IEnumerable<string> ValidateRequestedIncludes<T>(string[]? requestedIncludes)
        where T : class;
    ...
    T StripNavigationProperties<T>(T entity)
        where T : class;
}